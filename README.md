...
<!-- Yazı Animasyonu -->
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?size=23&color=1E90FF&center=true&vCenter=true&width=600&lines=Java+Geliştirici;Web+Arayüz+Geliştirme;OOP+%2F+Algoritma+%2F+SQL;Sürekli+Öğrenme+ve+Gelişim+Odaklı">
</p>
...
- **Java** – Nesne yönelimli programlama, temel algoritmalar  
- **Web Geliştirme** – HTML, CSS ve Bootstrap ile kullanıcı dostu arayüzler  
- **Veritabanı Yönetimi** – SQL sorguları ve veri modelleme  
- **Sürüm Kontrolü** – Git & GitHub iş akışları  
